          ...
          ${this.config.show_details&&o?B`
            <div class="port-details">
              ...
              <div class="details-content">
                ...
                ${o.deviceInfo.manufacturer||o.deviceInfo.mac_address||o.deviceInfo.ip_address||o.deviceInfo.traffic_detected?B`
                  ...
                  `:o.deviceInfo.traffic_detected?B`
                    <div class="detail-row">
                      <span
                        class="tooltip-trigger"
                        @mouseenter=${t=>this._showTooltip(t,"This port has active network traffic but no ARP entry. A device is present and communicating, but it likely has a static IP on a different subnet, or the port is in switch/bridge mode. Discovery cannot resolve its address from here.")}
